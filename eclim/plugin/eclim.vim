...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/Users/saratt/.eclipse/org.eclipse.platform_3.7.0_283092658/plugins/org.eclim_1.7.6'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/Users/saratt/.eclipse/org.eclipse.platform_3.7.0_283092658'
  if has('win32unix')
